package com.nadiannis.consume_rest_api.controller;

import com.nadiannis.consume_rest_api.model.Quote;
...
public class ConsumingRestController {
    ...
    public ResponseEntity<Quote> getQuoteRandom(){
        Quote quote = restTemplate.getForObject(API_QUOTE_URL.concat("/random"), Quote.class);
